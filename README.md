...
| Top-level `appendix.pdf`                                                     | Additional findings from the paper. First, we compared the **training times** of approaches. Second, we investigated the effect of including **inter-case features** in trace-level PPM approaches to account for interactions between traces.  Third, we looked at the **sensitivity** of approaches to the amount of available training data. Also, you can find details on hyperparameter selection and excerpt from standard deviations in MAE across runs with three different seeds, indicating models' robustness to random weight initialization.                                                                                                                                                                 |
