...
# =============================================================================
    ...
    l1_c1 = LSTM(args['l_size'],
                 ...
                 dropout=args.get('dropout', 0.2))(merged)

    l1_c3 = LSTM(args['l_size'],
                 activation=args['lstm_act'],
                 kernel_initializer='glorot_uniform',
                 return_sequences=True,
                 dropout=args.get('dropout', 0.2))(t_input)
...
# =============================================================================
    l2_c1 = LSTM(args['l_size'],
                 ...
                 dropout=args.get('dropout', 0.2))(batch1)
...
#   The layer specialized in role prediction
    l2_3 = LSTM(args['l_size'],
                ...
                kernel_initializer='glorot_uniform',
                return_sequences=False,
                dropout=args.get('dropout', 0.2))(batch3)
...
# =============================================================================
    ...
    lr = args.get('learning_rate', 0.002)
    if args['optim'] == 'Nadam':
        opt = Nadam(learning_rate=lr, beta_1=0.9, beta_2=0.999)
    elif args['optim'] == 'Adam':
        opt = Adam(learning_rate=lr, beta_1=0.9, beta_2=0.999, amsgrad=False)
    elif args['optim'] == 'SGD':
