...
class ModelOptimizer():
    ...
    def define_search_space(parms):
        space = {'model_type': hp.choice('model_type', parms['model_type']),
                 ...
                 'learning_rate': hp.choice('learning_rate', parms['learning_rate']),
                 'dropout': hp.choice('dropout', parms['dropout']),
    ...
    def _define_response(self, parms, status, loss, **kwargs) -> dict:
        ...
        data = {'n_size': parms['n_size'],
                ...
                'optim': parms['optim'],
                'learning_rate': parms.get('learning_rate', 0.002),
                'dropout': parms.get('dropout', 0.2),
